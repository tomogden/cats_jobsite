...
class CATS_editprofile extends CATS_Controller
{
    public function init()
    {
        ...
        $postURI = CATS_Utility::uri('cc=oneditprofile');

        $this->_template->assign('resume', $resume);
        $this->_template->assign('resumeURI', $resumeURI);
        $this->_template->assign('postURI', $postURI);
        ...
        $this->_template->display('editprofile.tpl.php');
    }
}
